              ...
              return (
                <>
                  <h6 className="fs-14 fw-semibold d-flex align-items-center justify-content-between mb-2">
                    Amount<span className="fw-normal">₹{totalAmount.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </h6>
                  <h6 className="fs-14 fw-semibold d-flex align-items-center justify-content-between mb-2">
                    Tax (0%)<span className="fw-normal">₹{tax.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </h6>
                  <h6 className="fs-14 fw-semibold d-flex align-items-center justify-content-between mb-2">
                    Discount (0%)<span className="fw-normal">₹{discount.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                  </h6>
                </>
              );
            })()}
            ...
            {(() => {
              ...
              return (
                <h6 className="fs-16 fw-bold d-flex align-items-center justify-content-between">
                  Total : <span>₹{totalAmount.toLocaleString("en-IN", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </h6>
              );
            })()}
          </div>
